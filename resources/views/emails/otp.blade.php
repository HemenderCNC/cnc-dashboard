                            ...
                            <td align="left" bgcolor="#FFFFFF" style="padding: 50px 30px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td align="center">
                                                <h1 style="margin: 0; font-weight: 600; font-size: 24px; line-height: 30px; color: #1A0726; text-transform: capitalize;">Password Reset OTP</h1>
                                                <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <p style="margin: 0 0 20px 0; font-size: 14px; color: #2C2C2C;">Dear User,</p>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td width="30%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">OTP Code</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td width="68%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 700; font-size: 14px; color: #1A0726;">{{ $otp }}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">Expires In</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td width="68%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">15 minutes</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <p style="margin: 20px 0 0 0; font-size: 14px; color: #2C2C2C;">If you did not request this, please ignore this email.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
