                                                        ...
                                                        <tr>
                                                            <td width="35%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">Start Date</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td width="2%" style="border-bottom: 1px solid #1A0726; padding: 7px 0;" valign="middle">
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $leave->start_date }}</p>
                                                            </td>
                                                        </tr>
                                                        <!-- End Date -->
                                                        <tr>
                                                            <td width="35%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">End Date</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td width="2%" style="border-bottom: 1px solid #1A0726; padding: 7px 0;" valign="middle">
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $leave->end_date }}</p>
                                                            </td>
                                                        </tr>
                                                        <!-- Duration -->
                                                        <tr>
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $leave->leave_duration }} day(s)@if($leave->half_day && $leave->half_day_type) ({{ ucwords(str_replace('_', ' ', $leave->half_day_type)) }})@endif</p>
                                                            </td>
                                                        </tr>
                                                        <!-- Reason -->
                                                        <tr>
                                                            <td width="35%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">Reason</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $leave->reason }}</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
