                            ...
                            <td align="left" bgcolor="#FFFFFF" style="padding: 50px 30px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td align="center">
                                                <h1 style="margin: 0; font-weight: 600; font-size: 24px; line-height: 30px; color: #1A0726; text-transform: capitalize;">Welcome Onboard!</h1>
                                                <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <p style="margin: 0 0 20px 0; font-size: 14px; color: #2C2C2C;">Dear {{ $user->name }},</p>
                                                <p style="margin: 0 0 20px 0; font-size: 14px; color: #2C2C2C;">Welcome to {{ config('app.name') }}! We are excited to have you on board. Your account has been created successfully. Here are your login details:</p>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tbody>
                                                        <!-- Email -->
                                                        <tr>
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="border-bottom: 1px solid #1A0726; padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $user->email }}</p>
                                                            </td>
                                                        </tr>
                                                        <!-- Password -->
                                                        <tr>
                                                            <td width="35%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="20px"><img src="https://codeandcore.sirv.com/newsletter/dot.png" alt="dot" style="display: block;" /></td>
                                                                        <td><p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">Password</p></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td width="63%" align="left" valign="middle" style="padding: 7px 0;">
                                                                <p style="margin: 0; font-weight: 400; font-size: 14px; color: #2C2C2C;">{{ $user->password ?? '********' }}</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <p style="margin: 20px 0 0 0; font-size: 14px; color: #2C2C2C;">Please log in to your account and complete your profile.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
